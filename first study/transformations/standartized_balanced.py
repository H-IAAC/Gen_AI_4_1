...
class StandardizedBalancedDataset:
    ...
    def get_data(self, df):
        ...
        label_columns=df['activity code']
    ...
    def get_data_train(self, normalize_data=False, resize_data=False):
        X_train, y_train = self.load_data('train.csv')
        X_train = self.preprocess(X_train, normalize_data, resize_data)
        return X_train, y_train
    
    def get_data_test(self, normalize_data=False, resize_data=False):
